    ...
    snapshot.forEach((childSnapshot) => {
        ...
        html += "<div class='ct-content-div'>";
            ...
            html += "<div class='ct-content-second-row'>";
                ...
                html += "</div>";
            html += "</div>";
            html += "<div data-hover='false' data-delay='0' data-w-id='491306b6-95d0-03c3-f777-3d6aa11c2282' style='height: 45px;' class='ct-content-second-row-dropdown w-dropdown'>";
                html += "<div class='second-row-accordion-toggle w-dropdown-toggle' id='w-dropdown-toggle-"+webflow_dropdown_count+"' aria-controls='w-dropdown-list-"+webflow_dropdown_count+"' aria-haspopup='menu' aria-expanded='false' role='button' tabindex='0'>";
                    html += "<div class='specific-date-header-div'>";
                    ...
                    html += "</div>";
                    html += "<div data-w-id='dcdd92ba-d953-a645-c063-ce67de900232' style='transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;' class='dropdown-arrow'></div>";
                html += "</div>";
